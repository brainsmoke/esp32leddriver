...
class Orbit:
    ...
    def __init__(self, leds, config=None, **kwargs):
        ...
        self.objects = (
            ( [1.047088, 0., 0.], [0., 3.943998e-4, 1.274987e-3], (0, 0, 0xffff*0.394)),
            ( [0., 0., 1.470884], [1.134319e-3, 3.149046e-4, 0.], (0xffff*0.394, 0xffff*0.394, 0x4000*0.394)),
            ( [0., 2.569612, 0.], [-4.989389e-4,0., 5.923611e-4], (0xffff*2.463, 0x2000*2.463, 0x7fff*2.463))
        )
    ...
    def next_frame(self, fbuf):
        ...
        for i in range(self.leds.n_leds):
            ...
            gi = int(g)
            bi = int(b)
            fbuf[i*3  ] = min(0xffff, ri)
            fbuf[i*3+1] = min(0xffff, gi)
            fbuf[i*3+2] = min(0xffff, bi)
